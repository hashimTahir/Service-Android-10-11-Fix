...
object IntentHelper {
    ...
    fun privacyPolicyWebIntent(): Intent {
        return Intent(Intent.ACTION_VIEW, Uri.parse("http://billiondollarapps.net/PrivacyPolicy.html"))
    }

    fun rateUsIntent(): Intent {
        return Intent(Intent.ACTION_VIEW, Uri.parse("market://details?id="+BuildConfig.APPLICATION_ID))
    }
